...
public class PersonUtil {
    ...
    public static String getPersonDetails(Person person) {
        ...
        sb.append(PREFIX_DATE + person.getDate().date + " ");
        sb.append(PREFIX_SLOT + person.getSlot().slot + " ");
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        ...
        descriptor.getSlot().ifPresent(slot -> sb.append(PREFIX_SLOT).append(slot.slot).append(" "));
        ...
        if (descriptor.getContacts().isPresent()) {
            Set<BillingContact> contacts = descriptor.getContacts().get();
            if (contacts.isEmpty()) {
